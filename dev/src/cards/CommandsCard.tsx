...
export const CommandsCard = ({ supported, lang }: { supported: boolean; lang: string }) => {
	...
	// Memoized so useCommands doesn't re-index on every render.
	...
	return (
		<Card
			...
			badge="commands"
			description="Map spoken words to callbacks. Single words match exactly; multi-word phrases match fuzzily. maxAlternatives={3} surfaces homophones so “red” still fires if the engine heard “read”."
			code={CODE}
		>
			<div className="card__stage card__stage--center">
				...
				{noMatch && (
					<p className="hint">No command matched — try “red”, “blue”, or “change the border to orange”.</p>
				)}
			</div>
		</Card>
	)
